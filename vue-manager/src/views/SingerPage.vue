  ...
  <div class="table">
    ...
    <div class="container">
      <div class="handle-box">
        <el-input v-model="select_word" class="handle-input mr10" size="medium" placeholder="筛选关键词"></el-input>
        <br><br>
        <el-button type="primary" size="medium" @click="centerDialogVisible = true">添加歌手</el-button>
        <el-button class="handle-del mr10" type="danger" size="medium" @click="delAll">批量删除</el-button>
      </div>
      <el-table ref="multipleTable" size="medium" border style="width: 100%" height="550px" :data="data" @selection-change="handleSelectionChange">
    ...
    <el-dialog title="添加歌手" v-model="centerDialogVisible" width="600px" center>
      <el-form
        class="demo-ruleForm"
        :model="registerForm"
        status-icon
        ...
        label-width="80px"
        >
        <el-form-item prop="name" label="歌手名" size="medium">
        ...
        <el-form-item prop="location" label="故乡" size="medium">
          <el-input v-model="registerForm.location" placeholder="故乡"></el-input>
        </el-form-item>
        <el-form-item prop="birth" label="出生" size="medium">
          <el-date-picker
            type="date"
            placeholder="选择日期"
        ...
        <el-form-item prop="introduction" label="歌手介绍" size="medium">
      ...
      <template #footer>
        <span class="dialog-footer">
          ...
          <el-button type="primary" size="medium" @click="addsinger">确 定</el-button>
        </span>
      </template>
    </el-dialog>
    ...
    <el-dialog title="编辑" v-model="editVisible" width="600px">
      <el-form ref="form" :model="form" label-width="60px">
        ...
        <el-form-item label="生日" size="medium">
      ...
      <template #footer>
        <span class="dialog-footer">
          ...
          <el-button type="primary" size="medium" @click="saveEdit">确 定</el-button>
        </span>
      </template>
    </el-dialog>
  ...
  watch: {
    select_word: function () {
      if (this.select_word === '') {
        ...
        for (let item of this.tempDate) {
          if (item.location.includes(this.select_word)) {
            this.tableData.push(item)
          }
        }
        for (let item of this.tempDate) {
