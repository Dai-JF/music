  ...
  <div class="table">
    ...
    <div class="container">
      <div class="handle-box">
        <el-input v-model="select_word" size="medium" placeholder="筛选相关用户" class="handle-input mr10"></el-input>
        <br><br>
      ...
      <el-table :data="data" border size="medium" style="width: 100%" ref="multipleTable" height="550px" @selection-change="handleSelectionChange">
    ...
    <!--添加新用户-->
    <el-dialog title="添加用户" v-model="centerDialogVisible" width="600px" center>
      <el-form :model="registerForm" status-icon :rules="rules" ref="registerForm" label-width="70px" class="demo-ruleForm">
        ...
        <el-form-item label="手机" prop="phoneNum" size="medium">
          <el-input  placeholder="手机" v-model="registerForm.phoneNum"></el-input>
        </el-form-item>
        <el-form-item label="邮箱" prop="email" size="medium">
          <el-input v-model="registerForm.email" placeholder="邮箱"></el-input>
        </el-form-item>
        <el-form-item label="生日" prop="birth" size="medium">
            <el-date-picker type="date" placeholder="选择日期" v-model="registerForm.birth" style="width: 100%;"></el-date-picker>
        </el-form-item>
        <el-form-item label="签名" prop="introduction" size="medium">
          <el-input  type="textarea" placeholder="签名" v-model="registerForm.introduction" ></el-input>
        </el-form-item>
        <el-form-item label="地区" prop="location" size="medium">
      ...
      <template #footer>
        <span class="dialog-footer">
          ...
          <el-button type="primary" size="medium" @click="addPeople">确 定</el-button>
        </span>
      </template>
    </el-dialog>
