<template>
  <div class="table">
    ...
    <div class="container">
      ...
      <el-table :data="data" size="medium" border style="width: 100%" ref="multipleTable" height="550px" @selection-change="handleSelectionChange">
    ...
    <!--添加歌曲-->
    <el-dialog title="添加歌曲" v-model="centerDialogVisible" width="600px" center>
      <el-form action="" :model="registerForm" id="tf">
         <el-form-item  label="歌曲名">
          <el-input name="name"  type="text" v-model="registerForm.name"></el-input>
        </el-form-item>
        <el-form-item label="专辑">
          <el-input name="introduction" type="text" v-model="registerForm.introduction"></el-input>
        </el-form-item>
        <el-form-item label="歌词">
          <el-input  name="lyric" type="textarea" v-model="registerForm.lyric"></el-input>
        </el-form-item>
        <el-form-item label="歌曲上传">
          <input  name="file" type="file" id="upadte-file-input">
        </el-form-item>
      </el-form>
      <template #footer>
  ...
  watch: {
    select_word: function () {
      if (this.select_word === '') {
        ...
        for (let item of this.tempDate) {
          if (item.lyric.includes(this.select_word)) {
            this.tableData.push(item)
          }
        }
      }
